...
class ToDoController extends BaseController
{
                ...
                case 1:
                    for ($i = $monthStart; $i <= $monthFinish; $i++) {
                        ...
                        if ($clientData['language'] == 1) {
                            ...
                            $resultTime2[$i] = $year;
                            $resultDeadline[$i] = ' до ' . $dbCurrentData[0]['deadline'] . ' ' . $monthArray[$i]['nameRus'] . ' ' . $year;
                            if ($k == 12) {
                            ...
                            $resultDeadline[$i] = ' до ' . $dbCurrentData[0]['deadline'] . ' ' . $monthArray[$i]['nameUa'] . ' ' . $year;
                            if ($k == 12) {
                                $resultTime2[$i] = $year - 1;
                            }
                            $resultTime2[$i] = $year;
                ...
                for ($i = $monthStart; $i <= $monthFinish; $i++) {
                    if (($i == 4) || ($i == 7) || ($i == 10) || ($i == 1)) {
                        if ($clientData['language'] == 1) {
                            ...
                            $resultTime1[$i] .= ' квартал ';
                            $resultDeadline[$i] = ' до ' . ($dbCurrentData[0]['deadline'] - $monthArray[$i]['length']) . ' ' . $monthArray[$i + 1]['nameRus'] . ' ' . $year;
                            ...
                            $resultTime1[$i] .= ' квартал ';
                            $resultDeadline[$i] = ' до ' . ($dbCurrentData[0]['deadline'] - $monthArray[$i]['length']) . ' ' . $monthArray[$i + 1]['nameUa'] . ' ' . $year;
                            $resultEn[$i] = $resultStart[$i] . $resultTime1[$i] . $resultTime2[$i] . $resultDeadline[$i];
                        }
                    }
                }
    ...
    public function skipWeekend($day, $month, $year)
    {
